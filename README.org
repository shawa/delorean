...
* [ ] Provide a monadic interpreter for the language that allows us to step through a program. (15)
...
* [ ] Extend the interpreter so that there is a new `Inspect` command (5 marks)
